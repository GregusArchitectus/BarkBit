...
#define MMA8451_REG_XYZ_DATA_CFG \
  0x0E  //!< XYZ_DATA_CFG register, sets dynamic range and high-pass filter for
        //!< output data
#define MMA8451_REG_HP_FILTER_CUTOFF \
  0x0F  //!< sets the high-pass filter cutoff frequency for removal of the offset
        //!< and slower changing acceleration data.
...
typedef enum {
  MMA8451_SLEEP_DATARATE_50_HZ = 0b00,
  MMA8451_SLEEP_DATARATE_12_5_HZ = 0b01,
  MMA8451_SLEEP_DATARATE_6_25_HZ = 0b10,
  MMA8451_SLEEP_DATARATE_1_56_HZ = 0b11
} mma8451_sleep_datarate_t;

typedef enum {
  MMA8451_NORMAL = 0b00,
  MMA8451_LOW_NOISE_LOW_POWER = 0b01,
  MMA8451_HIGH_RESOLUTION = 0b10,
 ...
 */
{
 public:
  ...
  void setRange(
      mma8451_range_t range);  //!< @param range Desired range of sensor
  mma8451_range_t getRange(
      void);  //!< @return Range of sensor, either 0b10, 0b01, or 0b00, 8G,
